...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "irukafi-workstation"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/irukafi"
  #   chef.validation_client_name = "irukafi-validator"
  #   chef.validation_key_path = ".chef/irukafi-validator.pem"
  # end
end
